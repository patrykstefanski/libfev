...
#ifndef FEV_SCHED_SHR_LOCKING_INTF_H
#define FEV_SCHED_SHR_LOCKING_INTF_H
...
struct fev_sched {
  ...
  fev_fiber_stq_head_t run_queue;
  struct fev_thr_mutex run_queue_lock;
...
#endif /* !FEV_SCHED_SHR_LOCKING_INTF_H */
